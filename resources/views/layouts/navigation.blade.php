 <nav x-data="{ open: false }" class="bg-white border-b border-green-100">
         ...
         <div class="flex justify-between h-16">
             <div class="flex">
                 ...
                 <div class="shrink-0 flex items-center">
                     ...
                     <a href="{{ route('full-calender') }}">
                         <x-application-logo2 class="block h-10 w-auto fill-current text-green-600" />
                     </a>
                     <a href="{{ route('full-calender') }}">
                         <x-application-logo3 class="block h-10 w-auto fill-current text-green-600" />
                     </a>
             ...
             <div class="hidden sm:flex sm:items-center sm:ml-6">
                 <x-dropdown align="right" width="48">
                     <x-slot name="trigger">
                         <button
                             class="flex items-center text-sm font-medium text-green-500 hover:text-green-700 hover:border-green-300 focus:outline-none focus:text-green-700 focus:border-green-300 transition duration-150 ease-in-out">
                             @auth
     ...
     <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
         ...
         <div class="pt-4 pb-1 border-t border-green-200">
             ...
             @else
                 <div class="px-4">
                     <div class="font-medium text-base text-green-800">guest</div>
                 </div>
